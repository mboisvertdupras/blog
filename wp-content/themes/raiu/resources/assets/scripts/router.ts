...
declare interface Listener { handler: EventListener, options: Options }
declare interface ListenerWithType extends Listener { type: string }

declare type ListOfListeners = {
  [key: string]: EventListener | Listener
} | ListenerWithType[]
...
export default class Router {
   ...
   * @param {string|ListOfListeners} type A case-sensitive string representing an event type
   ...
   */
  public on (typeOrTypes: string|ListOfListeners, listener?: EventListener, options?: Options): this {
